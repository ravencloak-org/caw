...
add test cases for everything with codecov

### Prompt 22

Add actions to run these in parallel.

### Prompt 23

added the token in secrets, add branch rules, start the slice 2 in parallel and add integration tests as well

### Prompt 24

add coderabbit as well and squak for postgress and sqlite
...
fix issues in slice 1, are PRs for work so far raised?
